...
For many years, I've been thinking about starting a blog.
...
Recently, I rewrote [echooff.dev](/) using [Astro](https://astro.build). What started as a technical rewrite slowly turned into something else. While polishing the setup, tweaking performance, and cleaning up the structure, I realized:
