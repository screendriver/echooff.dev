...
description: "Truthy and falsy checks in TypeScript are concise, but they hide intent and can introduce bugs. Prefer explicit checks for the values you actually care about."
---
